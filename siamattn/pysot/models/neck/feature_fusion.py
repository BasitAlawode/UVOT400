...
from siamattn.pysot.models.head.attention import PAM_Module, CAM_Calculate, CAM_Use
from siamattn.pysot.models.head.dcn.deform_conv import DeformConvPack, ModulatedDeformConvPack
