from SLTtrack.pytracking.evaluation.environment import EnvSettings

def local_env_settings():
    settings = EnvSettings()

    # Set your local paths here.
    settings.workspace_path = 'trained_trackers/'  # Base directory for saving network checkpoints.
    settings.network_path = settings.workspace_path + 'SLTtrack'
