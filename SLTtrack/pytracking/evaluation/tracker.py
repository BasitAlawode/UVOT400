...
from SLTtrack.pytracking.evaluation.environment import env_settings
import time
import cv2 as cv
from SLTtrack.pytracking.utils.visdom import Visdom
import matplotlib.pyplot as plt
import matplotlib.patches as patches
from SLTtrack.pytracking.utils.plotting import draw_figure, overlay_mask
from SLTtrack.pytracking.utils.convert_vot_anno_to_rect import convert_vot_anno_to_rect
from SLTtrack.ltr.data.bounding_box_utils import masks_to_bboxes
from SLTtrack.pytracking.evaluation.multi_object_wrapper import MultiObjectWrapper
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, run_id: int = None, display_name: str = None):
        ...
        if os.path.isdir(tracker_module_abspath):
            tracker_module = importlib.import_module('SLTtrack.pytracking.tracker.{}'.format(self.name))
    ...
    def get_parameters(self):
        """Get parameters."""
        param_module = importlib.import_module('SLTtrack.pytracking.parameter.{}.{}'.format(self.name, self.parameter_name))
