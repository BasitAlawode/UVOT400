from AiATrack.lib.test.evaluation.environment import EnvSettings
import os
...
def local_env_settings():
    ...
    settings.network_path = f'{os.getcwd()}/trained_trackers/AiATrack'
    settings.nfs_path = ''
    ...
    settings.save_dir = f'{os.getcwd()}/trained_trackers/AiATrack'
