...
from MixFormerV2.lib.utils.lmdb_utils import decode_img
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
        ...
        if os.path.isfile(tracker_module_abspath):
            tracker_module = importlib.import_module('MixFormerV2.lib.test.tracker.{}'.format(self.name))
    ...
    def get_parameters(self, tracker_params=None):
        """Get parameters."""
        param_module = importlib.import_module('MixFormerV2.lib.test.parameter.{}'.format(self.name))
