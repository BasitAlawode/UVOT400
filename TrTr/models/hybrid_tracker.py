...
# TrTr
import TrTr.datasets.utils
from TrTr.datasets.utils import crop_hwc, crop_image, siamfc_like_scale, get_exemplar_size, get_context_amount # TODO: move to utils
from TrTr.external_tracker import build_external_tracker
from TrTr.util.box_ops import box_cxcywh_to_xyxy
from TrTr.util.misc import is_dist_avail_and_initialized, nested_tensor_from_tensor_list
from TrTr.models import build_model
from TrTr.models.backbone import Backbone as Resnet
from TrTr.models.tracker import get_args_parser as baseline_tracker_args_parser
...
class Tracker():
    ...
    def init(self, image, bbox):
        ...
        debug_image = cv2.rectangle(template_image,
                                    (int(debug_bbox[0]), int(debug_bbox[1])),
                                    (int(debug_bbox[2]), int(debug_bbox[3])),(0,255,0),3)
