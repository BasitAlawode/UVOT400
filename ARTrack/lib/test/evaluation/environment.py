...
def create_default_local_file():
    ...
    with open(path, 'w') as f:
        ...
        f.write('from ARTrack.test.evaluation.environment import EnvSettings\n\n')
...
def create_default_local_file_ITP_test(workspace_dir, data_dir, save_dir):
    ...
    with open(path, 'w') as f:
        ...
        f.write('from ARTrack.lib.test.evaluation.environment import EnvSettings\n\n')
        f.write('def local_env_settings():\n')
        f.write('    settings = EnvSettings()\n\n')
        f.write('    # Set your local paths here.\n\n')
...
def env_settings():
    env_module_name = 'ARTrack.lib.test.evaluation.local'
    try:
